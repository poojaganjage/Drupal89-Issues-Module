  ...
  public function buildForm(array $form, FormStateInterface $form_state, $theme = '') {
    ...
    foreach (['logo' => 'logo.svg', 'favicon' => 'favicon.ico'] as $type => $default) {
      if (isset($form[$type]['settings'][$type . '_path'])) {
        ...
        $element['#description'] = t('Enter a path to an image. Drupal will look for the file relative to the 
          Drupal root or the public file system. Explicitly using <code>public://</code> before the path will only look in the public file system. Examples: <code>@local-file</code> or <code>@explicit-file</code>', [
