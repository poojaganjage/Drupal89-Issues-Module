...
use Drupal\layoutbuilder\TempStoreIdentifierInterface;
 ...
 */
function layoutbuilder_post_update_rebuild_plugin_dependencies(&$sandbox = NULL) {
 ...
 *
 * Previously
 * \Drupal\layoutbuilder\Entity\LayoutBuilderEntityViewDisplay::setComponent()
 ...
 */
function layoutbuilder_post_update_add_extra_fields(&$sandbox = NULL) {
 ...
 */
function layoutbuilder_post_update_section_storage_context_definitions() {
 ...
 */
function layoutbuilder_post_update_overrides_view_mode_annotation() {
  // Empty post-update hook.
}
 ...
 */
function layoutbuilder_post_update_cancel_link_to_discard_changes_form() {
  // Empty post-update hook.
}
 ...
 */
function layoutbuilder_post_update_remove_layout_is_rebuilding() {
  // Empty post-update hook.
}
 ...
 */
function layoutbuilder_post_update_routing_entity_form() {
  // Empty post-update hook.
}
 ...
 */
function layoutbuilder_post_update_discover_blank_layout_plugin() {
  // Empty post-update hook.
}
 ...
 */
function layoutbuilder_post_update_routing_defaults() {
  // Empty post-update hook.
}
 ...
 */
function layoutbuilder_post_update_discover_new_contextual_links() {
  // Empty post-update hook.
}
 ...
 */
function layoutbuilder_post_update_fix_tempstore_keys() {
  /** @var \Drupal\layoutbuilder\SectionStorage\SectionStorageManagerInterface $section_storage_manager */
  $section_storage_manager = \Drupal::service('plugin.manager.layoutbuilder.section_storage');
  ...
  foreach (array_keys($section_storage_manager->getDefinitions()) as $section_storage_type) {
    $key_value = $key_value_factory->get("tempstore.shared.layoutbuilder.section_storage.$section_storage_type");
 ...
 */
function layoutbuilder_post_update_section_third_party_settings_schema() {
  // Empty post-update hook.
}

/**
 * Clear caches due to dependency changes in the layoutbuilder render element.
 */
function layoutbuilder_post_update_layoutbuilder_dependency_change() {
  // Empty post-update hook.
}
 ...
 */
function layoutbuilder_post_update_update_permissions() {
 ...
 */
function layoutbuilder_post_update_make_layout_untranslatable() {
  ...
  foreach ($field_map as $entity_type_id => $field_infos) {
    if (isset($field_infos[OverridesSectionStorage::FIELD_NAME]['bundles'])) {
      ...
      foreach ($field_infos[OverridesSectionStorage::FIELD_NAME]['bundles'] as $bundle) {
        ...
        if (_layoutbuilder_bundle_has_no_translations($entity_type_id, $bundle) || _layoutbuilder_bundle_has_no_layouts($entity_type_id, $bundle)) {
 ...
 */
function _layoutbuilder_bundle_has_no_layouts($entity_type_id, $bundle) {
 ...
 */
function _layoutbuilder_bundle_has_no_translations($entity_type_id, $bundle) {
  $entity_update_manager = \Drupal::entityDefinitionUpdateManager();
  $entity_type = $entity_update_manager->getEntityType($entity_type_id);
