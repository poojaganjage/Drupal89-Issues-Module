 ...
 *
 * @see \Drupal\layoutbuilder\Plugin\SectionStorage\OverridesSectionStorage::access()
 *
 * @internal
...
class LayoutBuilderOverridesPermissions implements ContainerInjectionInterface {
  ...
  public function permissions() {
    ...
    /** @var \Drupal\layoutbuilder\Entity\LayoutEntityDisplayInterface[] $entity_displays */
    $entity_displays = $this->entityTypeManager->getStorage('entity_view_display')->loadByProperties(['third_party_settings.layoutbuilder.allow_custom' => TRUE]);
