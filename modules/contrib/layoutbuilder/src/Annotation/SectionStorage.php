...
namespace Drupal\layoutbuilder\Annotation;
 ...
 *
 * @see \Drupal\layoutbuilder\SectionStorage\SectionStorageManager
 * @see plugin_api
 *
 * @Annotation
 */
class SectionStorage extends Plugin {
   ...
   * @var array
   *
   * @see \Drupal\layoutbuilder\SectionStorage\SectionStorageManagerInterface::findByContext()
   */
   ...
   * @var bool
   *
   * @see \Drupal\layoutbuilder\Access\LayoutBuilderAccessCheck
   */
