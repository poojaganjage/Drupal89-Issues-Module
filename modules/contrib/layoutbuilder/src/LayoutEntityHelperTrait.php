...
trait LayoutEntityHelperTrait {
   ...
   *
   * @param \Drupal\layoutbuilder\Section[] $sections
   *   The layout sections.
   *
   * @return int[]
   *   The revision IDs.
   ...
   *   The layout sections.
   *
   * @return \Drupal\layoutbuilder\SectionComponent[]
   ...
   *   The entity.
   *
   * @return \Drupal\layoutbuilder\SectionStorageInterface|null
  ...
  private function sectionStorageManager() {
    return $this->sectionStorageManager ?: \Drupal::service('plugin.manager.layoutbuilder.section_storage');
  }
