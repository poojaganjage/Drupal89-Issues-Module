...
use Drupal\layoutbuilder\Plugin\Block\InlineBlock;
...
class InlineBlockEntityOperations implements ContainerInjectionInterface {
   ...
   *
   * @var \Drupal\layoutbuilder\InlineBlockUsageInterface
   */
  protected $usage;
   ...
   * @param \Drupal\layoutbuilder\InlineBlockUsageInterface $usage
   *   Inline block usage tracking service.
  ...
  public function __construct(EntityTypeManagerInterface $entityTypeManager, InlineBlockUsageInterface $usage, Connection $database, SectionStorageManagerInterface $section_storage_manager = NULL) {
    ...
    if ($section_storage_manager === NULL) {
      @trigger_error('The plugin.manager.layoutbuilder.section_storage service must be passed to \Drupal\layoutbuilder\InlineBlockEntityOperations::__construct(). It was added in Drupal 8.7.0 and will be required before Drupal 9.0.0.', E_USER_DEPRECATED);
  ...
  public function handleEntityDelete(EntityInterface $entity) {
    ...
    //   \Drupal\layoutbuilder\LayoutEntityHelperTrait::isLayoutCompatibleEntity().
   ...
   *
   * @param \Drupal\layoutbuilder\Plugin\Block\InlineBlock $block_plugin
   ...
   * @param \Drupal\layoutbuilder\SectionComponent $component
  ...
  protected function saveInlineBlockComponent(EntityInterface $entity, SectionComponent $component, $new_revision, $duplicate_blocks) {
    /** @var \Drupal\layoutbuilder\Plugin\Block\InlineBlock $plugin */
