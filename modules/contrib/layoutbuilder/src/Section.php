 ...
 * @see \Drupal\layoutbuilder\SectionComponent
 */
class Section implements ThirdPartySettingsInterface {
   ...
   *
   * @var \Drupal\layoutbuilder\SectionComponent[]
   */
   ...
   * @param \Drupal\layoutbuilder\SectionComponent[] $components
   ...
   * @param \Drupal\layoutbuilder\SectionComponent $new_component
   *   The component being inserted.
   *
   * @return $this
   *
