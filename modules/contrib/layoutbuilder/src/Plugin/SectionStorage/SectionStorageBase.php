...
abstract class SectionStorageBase extends ContextAwarePluginBase implements SectionStorageInterface, TempStoreIdentifierInterface {
   ...
   *
   * @param \Drupal\layoutbuilder\SectionListInterface $section_list
   *   The section list.
   *
   * @internal
  ...
  public function setSectionList(SectionListInterface $section_list) {
    @trigger_error('\Drupal\layoutbuilder\SectionStorageInterface::setSectionList() is deprecated in Drupal 8.7.0 and will be removed before Drupal 9.0.0. This method should no longer be used. The section list should be derived from context. See https://www.drupal.org/node/3016262.', E_USER_DEPRECATED);
    throw new \Exception('\Drupal\layoutbuilder\SectionStorageInterface::setSectionList() must no longer be called. The section list should be derived from context. See https://www.drupal.org/node/3016262.');
  }

  /**
   * Gets the section list.
   *
   * @return \Drupal\layoutbuilder\SectionListInterface
   *   The section list.
   */
