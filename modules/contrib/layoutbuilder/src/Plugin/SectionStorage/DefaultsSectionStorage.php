 ...
 *   \Drupal\layoutbuilder\Plugin\SectionStorage\OverridesSectionStorage.
...
class DefaultsSectionStorage extends SectionStorageBase implements ContainerFactoryPluginInterface, DefaultsSectionStorageInterface {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $container->get('layoutbuilder.sample_entity_generator')
    );
  }
   ...
   *
   * @return \Drupal\layoutbuilder\Entity\LayoutEntityDisplayInterface
  ...
  public function getLayoutBuilderUrl($rel = 'view') {
    return Url::fromRoute("layoutbuilder.{$this->getStorageType()}.{$this->getDisplay()->getTargetEntityTypeId()}.$rel", $this->getRouteParameters());
  }
  ...
  public function buildRoutes(RouteCollection $collection) {
    foreach ($this->getEntityTypes() as $entity_type_id => $entity_type) {
      ...
      if (isset($defaults['bundle_key'])) {
        $collection->get("layoutbuilder.defaults.$entity_type_id.view")
  ...
  protected function getEntityTypes() {
    return array_filter($this->entityTypeManager->getDefinitions(), function (EntityTypeInterface $entity_type) {
      return $entity_type->entityClassImplements(FieldableEntityInterface::class) && $entity_type->hasHandlerClass('form', 'layoutbuilder') && $entity_type->hasViewBuilderClass() && $entity_type->get('field_ui_base_route');
    });
  }
  ...
  public function getContextsDuringPreview() {
    ...
    $contexts['layoutbuilder.entity'] = EntityContext::fromEntity($entity);
    return $contexts;
  }
