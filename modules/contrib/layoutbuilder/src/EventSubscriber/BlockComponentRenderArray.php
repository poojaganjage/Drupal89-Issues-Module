...
namespace Drupal\layoutbuilder\EventSubscriber;
...
use Drupal\layoutbuilder\Access\LayoutPreviewAccessAllowed;
use Drupal\layoutbuilder\Event\SectionComponentBuildRenderArrayEvent;
use Drupal\layoutbuilder\LayoutBuilderEvents;
...
class BlockComponentRenderArray implements EventSubscriberInterface {
   ...
   *
   * @param \Drupal\layoutbuilder\Event\SectionComponentBuildRenderArrayEvent $event
  ...
  public function onBuildRender(SectionComponentBuildRenderArrayEvent $event) {
    ...
    if ($block instanceof RefinableDependentAccessInterface) {
      ...
      if (isset($contexts['layoutbuilder.entity'])) {
        if ($entity = $contexts['layoutbuilder.entity']->getContextValue()) {
          if ($event->inPreview()) {
