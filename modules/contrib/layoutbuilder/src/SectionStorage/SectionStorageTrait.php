...
trait SectionStorageTrait {
   ...
   * @param \Drupal\layoutbuilder\Section $section
   *   The layout section.
   *
   * @return $this
   */
   ...
   * @return $this
   *
   * @see \Drupal\layoutbuilder\Plugin\Layout\BlankLayout
   */
  protected function addBlankSection() {
    ...
    $this->appendSection(new Section('layoutbuilder_blank'));
    return $this;
  }
  ...
  protected function hasBlankSection() {
    ...
    // ::removeSection().
    return $this->hasSection(0) && $this->getSection(0)->getLayoutId() === 'layoutbuilder_blank';
  }
