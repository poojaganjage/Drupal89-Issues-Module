...
interface SectionStorageManagerInterface extends DiscoveryInterface {
   ...
   *   \Drupal\layoutbuilder\SectionStorage\SectionStorageManagerInterface::load()
   ...
   *
   * @deprecated in drupal:8.7.0 and is removed from drupal:9.0.0.
   *   \Drupal\layoutbuilder\SectionStorageInterface::deriveContextsFromRoute()
   *   and \Drupal\layoutbuilder\SectionStorage\SectionStorageManagerInterface::load()
   *   should be used instead. See https://www.drupal.org/node/3012353.
   */
