...
namespace Drupal\layoutbuilder\SectionStorage;
...
use Drupal\layoutbuilder\Annotation\SectionStorage;
 ...
 * via \Drupal\layoutbuilder\SectionStorage\SectionStorageManagerInterface.
...
class SectionStorageManager extends DefaultPluginManager implements SectionStorageManagerInterface {
  ...
  public function __construct(\Traversable $namespaces, CacheBackendInterface $cache_backend, ModuleHandlerInterface $module_handler, ContextHandlerInterface $context_handler = NULL) {
    ...
    if (!$context_handler) {
      @trigger_error('The context.handler service must be passed to \Drupal\layoutbuilder\SectionStorage\SectionStorageManager::__construct(); it was added in Drupal 8.7.0 and will be required before Drupal 9.0.0.', E_USER_DEPRECATED);
      $context_handler = \Drupal::service('context.handler');
    }
    $this->contextHandler = $context_handler;

    $this->alterInfo('layoutbuilder_section_storage');
    $this->setCacheBackend($cache_backend, 'layoutbuilder_section_storage_plugins');
  }
  ...
  public function loadFromStorageId($type, $id) {
    @trigger_error('\Drupal\layoutbuilder\SectionStorage\SectionStorageManagerInterface::loadFromStorageId() is deprecated in Drupal 8.7.0 and will be removed before Drupal 9.0.0. \Drupal\layoutbuilder\SectionStorage\SectionStorageManagerInterface::load() should be used instead. See https://www.drupal.org/node/3012353.', E_USER_DEPRECATED);
  ...
  public function loadFromRoute($type, $value, $definition, $name, array $defaults) {
    @trigger_error('\Drupal\layoutbuilder\SectionStorage\SectionStorageManagerInterface::loadFromRoute() is deprecated in Drupal 8.7.0 and will be removed before Drupal 9.0.0. \Drupal\layoutbuilder\SectionStorageInterface::deriveContextsFromRoute() and \Drupal\layoutbuilder\SectionStorage\SectionStorageManagerInterface::load() should be used instead. See https://www.drupal.org/node/3012353.', E_USER_DEPRECATED);
