...
class OverridesEntityForm extends ContentEntityForm {
  ...
  public function getBaseFormId() {
    return $this->getEntity()->getEntityTypeId() . '_layoutbuilder_form';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state, SectionStorageInterface $section_storage = NULL) {
    ...
    // @todo \Drupal\layoutbuilder\Field\LayoutSectionItemList::defaultAccess()
    ...
    $form['layoutbuilder_message'] = $this->buildMessage($section_storage->getContextValue('entity'), $section_storage);
    return $form;
  }
   ...
   * @param \Drupal\layoutbuilder\OverridesSectionStorageInterface $section_storage
   ...
   *
   * @return \Drupal\layoutbuilder\SectionStorageInterface
