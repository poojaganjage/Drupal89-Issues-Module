...
class LayoutBuilderEntityViewDisplayForm extends EntityViewDisplayEditForm {
   ...
   *
   * @var \Drupal\layoutbuilder\Entity\LayoutEntityDisplayInterface
   */
  protected $entity;
   ...
   * The storage section.
   *
   * @var \Drupal\layoutbuilder\DefaultsSectionStorageInterface
   */
   ...
   *
   * @param \Drupal\layoutbuilder\Entity\LayoutEntityDisplayInterface $display
   *   The entity display.
   *
   * @return bool
  ...
  protected function copyFormValuesToEntity(EntityInterface $entity, array $form, FormStateInterface $form_state) {
    ...
    /** @var \Drupal\layoutbuilder\Entity\LayoutEntityDisplayInterface $entity */
