 ...
 *   \Drupal\layoutbuilder\Access\LayoutBuilderAccessCheck instead. See
...
class LayoutSectionAccessCheck implements AccessInterface {
  ...
  public function access(RouteMatchInterface $route_match, AccountInterface $account) {
    @trigger_error(__NAMESPACE__ . '\LayoutSectionAccessCheck is deprecated in Drupal 8.7.0 and will be removed before Drupal 9.0.0. Use \Drupal\layoutbuilder\Access\LayoutBuilderAccessCheck instead. See https://www.drupal.org/node/3039551.', E_USER_DEPRECATED);
