 ...
 *
 * Cache context ID: 'layoutbuilder_is_active:%entity_type_id', e.g.
 * 'layoutbuilder_is_active:node' (to vary by whether the Node entity type has
...
class LayoutBuilderIsActiveCacheContext implements CalculatedCacheContextInterface {
   ...
   *   The entity type ID.
   *
   * @return \Drupal\layoutbuilder\Entity\LayoutEntityDisplayInterface|null
