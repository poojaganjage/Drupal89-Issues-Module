...
/**
 * @coversDefaultClass \Drupal\layoutbuilder\LayoutEntityHelperTrait
 *
 * @group layoutbuilder
 */
class LayoutEntityHelperTraitTest extends KernelTestBase {
  ...
  public function testGetSectionStorageForEntity($entity_type_id, $values, $expected_context_keys) {
    ...
    $this->container->set('plugin.manager.layoutbuilder.section_storage', $section_storage_manager->reveal());
    ...
    elseif ($entity instanceof FieldableEntityInterface) {
      ...
      /** @var \Drupal\layoutbuilder\Entity\LayoutBuilderEntityViewDisplay $display_entity */
      ...
      $this->assertEquals($expected_display->getThirdPartySettings('layoutbuilder'), $display_entity->getThirdPartySettings('layoutbuilder'));
    }
    else {
