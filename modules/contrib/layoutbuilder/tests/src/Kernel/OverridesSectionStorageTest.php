...
class OverridesSectionStorageTest extends KernelTestBase {
  ...
  protected function setUp() {
    ...
    $definition = $this->container->get('plugin.manager.layoutbuilder.section_storage')->getDefinition('overrides');
  ...
  public function testGetContextsDuringPreview() {
    ...
    $expected = [
      'view_mode',
      'layoutbuilder.entity',
    ];
    $result = $this->plugin->getContextsDuringPreview();
    $this->assertEquals($expected, array_keys($result));
    $this->assertSame($context, $result['layoutbuilder.entity']);
  }
