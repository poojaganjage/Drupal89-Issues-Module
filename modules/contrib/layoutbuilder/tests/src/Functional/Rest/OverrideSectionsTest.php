...
class OverrideSectionsTest extends LayoutRestTestBase {
  ...
  public function testOverrideField() {
    ...
    $this->assertArrayNotHasKey('layoutbuilder__layout', $get_data);
    ...
    $new_node['layoutbuilder__layout'] = [];
    ...
    $this->assertResourceErrorResponse(403, 'Access denied on creating field \'layoutbuilder__layout\'.', $response);
    ...
    $patch_data['layoutbuilder__layout'] = [];
    $response = $this->request(
      'PATCH',
      Url::fromRoute(
        'rest.entity.node.PATCH',
    ...
    $this->assertResourceErrorResponse(403, 'Access denied on updating field \'layoutbuilder__layout\'.', $response);
