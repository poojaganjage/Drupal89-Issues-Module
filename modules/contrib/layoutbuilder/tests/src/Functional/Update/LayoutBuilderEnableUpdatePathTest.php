...
namespace Drupal\Tests\layoutbuilder\Functional\Update;
...
class LayoutBuilderEnableUpdatePathTest extends UpdatePathTestBase {
  ...
  protected function assertLayoutBuilderSettings($expected, $entity_type_id, $bundle, $view_mode) {
    $this->assertEquals($expected, \Drupal::config("core.entity_view_display.$entity_type_id.$bundle.$view_mode")->get('third_party_settings.layoutbuilder'));
  }
