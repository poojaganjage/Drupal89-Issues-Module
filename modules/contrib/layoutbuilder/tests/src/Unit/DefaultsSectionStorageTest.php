...
use Drupal\layoutbuilder\Entity\SampleEntityGeneratorInterface;
use Drupal\layoutbuilder\Plugin\SectionStorage\DefaultsSectionStorage;
...
/**
 * @coversDefaultClass \Drupal\layoutbuilder\Plugin\SectionStorage\DefaultsSectionStorage
 *
 * @group layoutbuilder
 */
class DefaultsSectionStorageTest extends UnitTestCase {
   ...
   * The plugin.
   *
   * @var \Drupal\layoutbuilder\Plugin\SectionStorage\DefaultsSectionStorage
   */
  protected $plugin;
   ...
   *
   * @var \Drupal\layoutbuilder\Entity\SampleEntityGeneratorInterface
   */
  ...
  public function testBuildRoutes() {
    ...
    $no_field_ui_route->hasHandlerClass('form', 'layoutbuilder')->willReturn(TRUE);
    ...
    $unknown_field_ui_route->hasHandlerClass('form', 'layoutbuilder')->willReturn(TRUE);
    ...
    $with_bundle_key->hasHandlerClass('form', 'layoutbuilder')->willReturn(TRUE);
    ...
    $with_bundle_parameter->hasHandlerClass('form', 'layoutbuilder')->willReturn(TRUE);
    ...
    $expected = [
      ...
      'layoutbuilder.defaults.with_bundle_key.view' => new Route(
        ...
        [
          ...
          'section_storage' => '',
          '_entity_form' => 'entity_view_display.layoutbuilder',
      ...
      'layoutbuilder.defaults.with_bundle_key.discard_changes' => new Route(
      ...
      'layoutbuilder.defaults.with_bundle_key.disable' => new Route(
        ...
        [
          ...
          'section_storage_type' => 'defaults',
          'section_storage' => '',
          '_form' => '\Drupal\layoutbuilder\Form\LayoutBuilderDisableForm',
        ],
        [
          '_field_ui_view_mode_access' => 'administer with_bundle_key display',
          '_layoutbuilder_access' => 'view',
      ...
      'layoutbuilder.defaults.with_bundle_parameter.view' => new Route(
      ...
      'layoutbuilder.defaults.with_bundle_parameter.discard_changes' => new Route(
      ...
      'layoutbuilder.defaults.with_bundle_parameter.disable' => new Route(
