...
/**
 * @coversDefaultClass \Drupal\layoutbuilder\Plugin\SectionStorage\OverridesSectionStorage
 *
 * @group layoutbuilder
 */
class OverridesSectionStorageTest extends UnitTestCase {
   ...
   * The plugin.
   *
   * @var \Drupal\layoutbuilder\Plugin\SectionStorage\OverridesSectionStorage
   */
  protected $plugin;
   ...
   *
   * @expectedDeprecation \Drupal\layoutbuilder\SectionStorageInterface::extractIdFromRoute() is deprecated in Drupal 8.7.0 and will be removed before Drupal 9.0.0. \Drupal\layoutbuilder\SectionStorageInterface::deriveContextsFromRoute() should be used instead. See https://www.drupal.org/node/3016262.
   *
   * @group legacy
   */
   ...
   *
   * @expectedDeprecation \Drupal\layoutbuilder\SectionStorageInterface::getSectionListFromId() is deprecated in Drupal 8.7.0 and will be removed before Drupal 9.0.0. The section list should be derived from context. See https://www.drupal.org/node/3016262.
   *
   * @group legacy
   */
   ...
   * @covers \Drupal\layoutbuilder\Routing\LayoutBuilderRoutesTrait::buildLayoutRoutes
   */
  public function testBuildRoutes() {
    ...
    $no_layoutbuilder_form = $this->prophesize(EntityTypeInterface::class);
    $no_layoutbuilder_form->entityClassImplements(FieldableEntityInterface::class)->willReturn(TRUE);
    $no_layoutbuilder_form->hasHandlerClass('form', 'layoutbuilder')->willReturn(FALSE);
    $entity_types['no_layoutbuilder_form'] = $no_layoutbuilder_form->reveal();
    $this->entityFieldManager->getFieldStorageDefinitions('no_layoutbuilder_form')->shouldNotBeCalled();
    ...
    $no_view_builder->hasHandlerClass('form', 'layoutbuilder')->willReturn(TRUE);
    ...
    $no_canonical_link->hasHandlerClass('form', 'layoutbuilder')->willReturn(TRUE);
    ...
    $canonical_link_no_route->hasHandlerClass('form', 'layoutbuilder')->willReturn(TRUE);
    ...
    $from_canonical->hasHandlerClass('form', 'layoutbuilder')->willReturn(TRUE);
    ...
    $with_string_id->hasHandlerClass('form', 'layoutbuilder')->willReturn(TRUE);
    ...
    $with_integer_id->hasHandlerClass('form', 'layoutbuilder')->willReturn(TRUE);
    ...
    $expected = [
      ...
      'layoutbuilder.overrides.from_canonical.view' => new Route(
        '/entity/{entity}/layout',
        [
          'entity_type_id' => 'from_canonical',
          'section_storage_type' => 'overrides',
          'section_storage' => '',
          '_entity_form' => 'from_canonical.layoutbuilder',
          '_title_callback' => '\Drupal\layoutbuilder\Controller\LayoutBuilderController::title',
        ],
        [
        ...
        [
          'parameters' => [
            'section_storage' => ['layoutbuilder_tempstore' => TRUE],
            'from_canonical' => ['type' => 'entity:from_canonical'],
          ],
          '_layoutbuilder' => TRUE,
        ]
      ),
      'layoutbuilder.overrides.from_canonical.discard_changes' => new Route(
        '/entity/{entity}/layout/discard-changes',
        [
          'entity_type_id' => 'from_canonical',
          'section_storage_type' => 'overrides',
          'section_storage' => '',
          '_form' => '\Drupal\layoutbuilder\Form\DiscardLayoutChangesForm',
        ],
        [
          '_layoutbuilder_access' => 'view',
          'custom requirement' => 'from_canonical_route',
      ...
      'layoutbuilder.overrides.from_canonical.revert' => new Route(
        '/entity/{entity}/layout/revert',
        [
          'entity_type_id' => 'from_canonical',
          'section_storage_type' => 'overrides',
          'section_storage' => '',
          '_form' => '\Drupal\layoutbuilder\Form\RevertOverridesForm',
        ],
        [
          '_layoutbuilder_access' => 'view',
          'custom requirement' => 'from_canonical_route',
      ...
      'layoutbuilder.overrides.with_string_id.view' => new Route(
        '/entity/{entity}/layout',
        [
          ...
          'section_storage' => '',
          '_title_callback' => '\Drupal\layoutbuilder\Controller\LayoutBuilderController::title',
          '_entity_form' => 'with_string_id.layoutbuilder',
        ],
        [
          '_layoutbuilder_access' => 'view',
        ],
      ...
      'layoutbuilder.overrides.with_string_id.discard_changes' => new Route(
        '/entity/{entity}/layout/discard-changes',
        [
          'entity_type_id' => 'with_string_id',
          'section_storage_type' => 'overrides',
      ...
      'layoutbuilder.overrides.with_string_id.revert' => new Route(
        '/entity/{entity}/layout/revert',
        [
          'entity_type_id' => 'with_string_id',
          'section_storage_type' => 'overrides',
      ...
      'layoutbuilder.overrides.with_integer_id.view' => new Route(
        '/entity/{entity}/layout',
        [
          ...
          'section_storage' => '',
          '_title_callback' => '\Drupal\layoutbuilder\Controller\LayoutBuilderController::title',
          '_entity_form' => 'with_integer_id.layoutbuilder',
        ],
        [
          '_layoutbuilder_access' => 'view',
          'with_integer_id' => '\d+',
      ...
      'layoutbuilder.overrides.with_integer_id.discard_changes' => new Route(
        '/entity/{entity}/layout/discard-changes',
        [
          'entity_type_id' => 'with_integer_id',
          'section_storage_type' => 'overrides',
      ...
      'layoutbuilder.overrides.with_integer_id.revert' => new Route(
        '/entity/{entity}/layout/revert',
        [
          'entity_type_id' => 'with_integer_id',
          'section_storage_type' => 'overrides',
