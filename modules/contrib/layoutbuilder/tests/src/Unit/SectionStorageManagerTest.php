...
use Drupal\layoutbuilder\SectionStorage\SectionStorageManager;
use Drupal\layoutbuilder\SectionStorageInterface;
use Drupal\Tests\UnitTestCase;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * @coversDefaultClass \Drupal\layoutbuilder\SectionStorage\SectionStorageManager
 *
 * @group layoutbuilder
 */
class SectionStorageManagerTest extends UnitTestCase {
   ...
   *
   * @var \Drupal\layoutbuilder\SectionStorage\SectionStorageManager
   */
  protected $manager;
   ...
   * @covers ::__construct
   *
   * @expectedDeprecation The context.handler service must be passed to \Drupal\layoutbuilder\SectionStorage\SectionStorageManager::__construct(); it was added in Drupal 8.7.0 and will be required before Drupal 9.0.0.
   *
   * @group legacy
   */
