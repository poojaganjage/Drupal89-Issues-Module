...
use Drupal\layoutbuilder\EventSubscriber\BlockComponentRenderArray;
use Drupal\layoutbuilder\SectionComponent;
use Drupal\Tests\UnitTestCase;
use Prophecy\Argument;

/**
 * @coversDefaultClass \Drupal\layoutbuilder\EventSubscriber\BlockComponentRenderArray
 * @group layoutbuilder
 */
class BlockComponentRenderArrayTest extends UnitTestCase {
  ...
  public function testOnBuildRender($refinable_dependent_access) {
    ...
    if ($refinable_dependent_access) {
      ...
      $contexts['layoutbuilder.entity'] = $context->reveal();
