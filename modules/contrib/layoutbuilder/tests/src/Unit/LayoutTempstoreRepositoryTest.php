...
use Drupal\layoutbuilder\LayoutTempstoreRepository;
use Drupal\layoutbuilder\SectionStorageInterface;
use Drupal\Tests\UnitTestCase;

/**
 * @coversDefaultClass \Drupal\layoutbuilder\LayoutTempstoreRepository
 * @group layoutbuilder
 */
class LayoutTempstoreRepositoryTest extends UnitTestCase {
  ...
  public function testGetEmptyTempstore() {
    ...
    $tempstore_factory->get('layoutbuilder.section_storage.my_storage_type')->willReturn($tempstore->reveal());
