...
use Drupal\layoutbuilder\Routing\LayoutTempstoreParamConverter;
...
/**
 * @coversDefaultClass \Drupal\layoutbuilder\Routing\LayoutTempstoreParamConverter
 *
 * @group layoutbuilder
 */
class LayoutTempstoreParamConverterTest extends UnitTestCase {
  ...
  public function testConvert() {
    ...
    $value = 'some_value';
    $definition = ['layoutbuilder_tempstore' => TRUE];
