...
/**
 * @coversDefaultClass \Drupal\layoutbuilder\Plugin\Block\FieldBlock
 *
 * @group field
 */
class FieldBlockTest extends WebDriverTestBase {
  ...
  protected static $modules = [
    ...
    'layoutbuilder',
    'user',
    // See \Drupal\layoutbuilder_fieldblock_test\Plugin\Block\FieldBlock.
    'layoutbuilder_fieldblock_test',
  ];
