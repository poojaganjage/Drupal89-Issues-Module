...
namespace Drupal\Tests\layoutbuilder\FunctionalJavascript;
...
class LayoutBuilderTest extends WebDriverTestBase {
  ...
  public function testLayoutBuilderUi() {
    ...
    $this->assertOffCanvasFormAfterWait('layoutbuilder_update_block');
    ...
    $this->assertOffCanvasFormAfterWait('layoutbuilder_remove_block');
    ...
    $this->assertOffCanvasFormAfterWait('layoutbuilder_remove_section');
  ...
  public function testConfigurableLayoutSections() {
    ...
    \Drupal::entityTypeManager()
      ...
      ->enable()
      ->setThirdPartySetting('layoutbuilder', 'enabled', TRUE)
      ->setThirdPartySetting('layoutbuilder', 'allow_custom', TRUE)
      ->save();
    ...
    $this->assertOffCanvasFormAfterWait('layoutbuilder_configure_section');
  ...
  public function testLayoutNoDialog() {
    ...
    $this->drupalGet(Url::fromRoute('layoutbuilder.choose_section', [
    ...
    // Add a block.
    $this->drupalGet(Url::fromRoute('layoutbuilder.add_block', [
      'section_storage_type' => 'overrides',
      'section_storage' => 'node.1',
      'delta' => 0,
      'region' => 'content',
    ...
    // Remove the section.
    $this->drupalGet(Url::fromRoute('layoutbuilder.remove_section', [
      'section_storage_type' => 'overrides',
      'section_storage' => 'node.1',
      'delta' => 0,
    ]));
  ...
  private function openAddBlockForm($block_title) {
    ...
    $this->assertOffCanvasFormAfterWait('layoutbuilder_add_block');
  }
