...
class ContextualLinksTest extends WebDriverTestBase {
  ...
  protected function assertCorrectContextualLinksInUi() {
    ...
    $layoutbuilder_specific_contextual_links = $page->findAll('css', '[data-contextual-id*=\'layoutbuilder_block:\']');
    $this->assertNotEmpty($layoutbuilder_specific_contextual_links);

    // Confirms Layout Builder contextual links are the only contextual links
    // inside the Layout Builder UI.
    $this->assertSameSize($layoutbuilder_specific_contextual_links, $page->findAll('css', '#layout-builder [data-contextual-id]'));
  }
  ...
  protected function assertCorrectContextualLinksInNode() {
    ...
    $this->assertEmpty($page->findAll('css', '[data-contextual-id*=\'layoutbuilder_block:\']'));
