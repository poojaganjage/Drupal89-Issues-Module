...
class LayoutBuilderOptInTest extends WebDriverTestBase {
  ...
  protected function setUp() {
    ...
    $this->container->get('module_installer')->install(['layoutbuilder']);
    $this->rebuildAll();
  ...
  public function testDefaultValues() {
    ...
    $layoutbuilder_ui = $this->getPathForFieldBlock('node', 'after', 'default', 'body');
    ...
    $this->drupalGet($layoutbuilder_ui);
  ...
  protected function getPathForFieldBlock($entity_type_id, $bundle, $view_mode, $field_name) {
    ...
    return 'layoutbuilder/update/block/defaults/node.after.default/0/content/' . $body_component->getUuid();
  }
