...
// Create a section with a context-aware block with a layoutbuilder.entity
...
$display['third_party_settings']['layoutbuilder']['sections'][] = $section_array;
...
$connection->insert('node__layoutbuilder__layout')
  ...
  ->values([
    ...
    'langcode' => 'en',
    'delta' => '0',
    'layoutbuilder__layout_section' => $section_string,
  ])
  ->execute();
